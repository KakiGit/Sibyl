#!/usr/bin/env python
"""Optimized IPC server for low-resource hardware using qwen2.5:0.5b."""
...
class OptimizedMemoryHandler:
    """Handler with pre-computed embeddings and caching."""
...
async def main():
    logger.info("Connecting to FalkorDB at localhost:6379...")
    ...
    logger.info("Using qwen2.5:0.5b for LLM (optimized for low-resource hardware)")

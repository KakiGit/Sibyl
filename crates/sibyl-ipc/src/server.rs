...
impl IpcServer {
    ...
    async fn handle_request(request: Request) -> Response {
        match request.method {
            crate::Method::MemoryQuery => Response {
                jsonrpc: "2.0".to_string(),
                id: request.id,
                result: Some(serde_json::json!({"memories": []})),
                error: None,
            },
            crate::Method::MemoryAddEpisode => Response {
                jsonrpc: "2.0".to_string(),
                id: request.id,
                result: Some(serde_json::json!({"status": "ok"})),
                error: None,
            },
            crate::Method::MemoryAddUserFact => Response {
                jsonrpc: "2.0".to_string(),
                id: request.id,
                result: Some(serde_json::json!({"status": "ok"})),
                error: None,
            },
            crate::Method::MemoryGetContext => Response {
                jsonrpc: "2.0".to_string(),
                id: request.id,
                result: Some(serde_json::json!({"context": ""})),
                error: None,
            },
            crate::Method::PromptBuild => Response {
                jsonrpc: "2.0".to_string(),
                id: request.id,
                result: Some(serde_json::json!({"prompt": ""})),
                error: None,
            },
            crate::Method::RelevanceEvaluate => Response {
                jsonrpc: "2.0".to_string(),
                id: request.id,
                result: Some(serde_json::json!({"relevance": 0.0})),
                error: None,
            },
            crate::Method::MemoryModify => Response {
                jsonrpc: "2.0".to_string(),
                id: request.id,
                result: Some(serde_json::json!({"status": "ok"})),
                error: None,
            },
            crate::Method::MemoryDelete => Response {
                jsonrpc: "2.0".to_string(),
                id: request.id,
                result: Some(serde_json::json!({"status": "ok"})),
                error: None,
            },
            crate::Method::MemoryList => Response {
                jsonrpc: "2.0".to_string(),
                id: request.id,
